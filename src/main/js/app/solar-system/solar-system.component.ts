...
export class SolarSystemComponent implements OnInit {
  ...
  ngOnInit(): void {
    var svg = d3.select("figure#main_view").append("svg")
      .attr("width", this.w)
      .attr("height", this.h)
      .append("g");

    this.displaySolarSystem(svg);
  }
  ...
  private displayPlanets(view, x, y, width, height, planets) {
    ...
    var planetsView = view.append("g")
      ...
      .on("click", (d) => { this.cleanView(); this.displayPlanetInfo(view, width / 2, height / 3, width, height, d); });
